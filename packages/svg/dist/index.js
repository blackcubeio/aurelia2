...
const ISvgConfiguration = aurelia.DI.createInterface('ISvgConfiguration', x => x.singleton(SvgConfigure));
class SvgConfigure {
    constructor() {
        this._config = {
            svgStyle: 'contents',
...
const ISpritesServices = /*@__PURE__*/ aurelia.DI.createInterface('ISpritesServices', (x) => x.singleton(SpritesServices));
class SpritesServices {
    constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('SpritesServices'), options = aurelia.resolve(ISvgConfiguration)) {
        this.logger = logger;
...
let SvgSprite = (() => {
    let _classDecorators = [aurelia.containerless(), aurelia.customElement({
            name: 'bc-svg-sprite',
            template
        })];
    ...
    _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('SvgSprite'), spriteServices = aurelia.resolve(ISpritesServices)) {
    ...
    (() => {
        ...
        _name_decorators = [aurelia.bindable()];
        _class_decorators = [aurelia.bindable()];
        _style_decorators = [aurelia.bindable()];
        _width_decorators = [aurelia.bindable()];
        _height_decorators = [aurelia.bindable()];
        _ariaHidden_decorators = [aurelia.bindable()];
        _focusable_decorators = [aurelia.bindable()];
        _drawSvg_decorators = [aurelia.watch('name')];
...
exports.ISvgConfiguration = ISvgConfiguration;
exports.ToolsConfiguration = ToolsConfiguration;
