...
import {ConfigInterface,IRgaaConfiguration} from './configure';
...
function createRgaaConfiguration(options: Partial<ConfigInterface>) {
    return {
...
export const RgaaConfiguration = createRgaaConfiguration({});