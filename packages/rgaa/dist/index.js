...
const IRgaaConfiguration = aurelia.DI.createInterface('IRgaaConfiguration', x => x.singleton(Configure));
class Configure {
    constructor() {
        this._config = {
...
let AriaCurrent = (() => {
    ...
    var AriaCurrent = _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('AriaCurrent'), ea = aurelia.resolve(aurelia.IEventAggregator), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode)) {
            this.logger = logger;
            this.ea = ea;
...
let AriaExpanded = (() => {
    ...
    var AriaExpanded = _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('AriaExpanded'), ea = aurelia.resolve(aurelia.IEventAggregator), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode)) {
            this.logger = logger;
            this.ea = ea;
            this.platform = platform;
            this.element = element;
...
let AriaHidden = (() => {
    ...
    var AriaHidden = _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('AriaHidden'), ea = aurelia.resolve(aurelia.IEventAggregator), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode)) {
            this.logger = logger;
            this.ea = ea;
            this.platform = platform;
            this.element = element;
...
let AriaInvalid = (() => {
    ...
    var AriaInvalid = _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('AriaInvalid'), ea = aurelia.resolve(aurelia.IEventAggregator), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode)) {
            this.logger = logger;
            this.ea = ea;
            this.platform = platform;
            this.element = element;
...
let AriaLabel = (() => {
    ...
    var AriaLabel = _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('AriaLabel'), ea = aurelia.resolve(aurelia.IEventAggregator), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode)) {
            this.logger = logger;
            this.ea = ea;
            this.platform = platform;
            this.element = element;
...
let AriaLive = (() => {
    ...
    var AriaLive = _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('AriaLive'), ea = aurelia.resolve(aurelia.IEventAggregator), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode)) {
            this.logger = logger;
            this.ea = ea;
            this.platform = platform;
            this.element = element;
...
let AriaModal = (() => {
    ...
    var AriaModal = _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('AriaModal'), ea = aurelia.resolve(aurelia.IEventAggregator), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode)) {
            this.logger = logger;
            this.ea = ea;
            this.platform = platform;
            this.element = element;
...
let AriaSelected = (() => {
    ...
    var AriaSelected = _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('AriaSelected'), ea = aurelia.resolve(aurelia.IEventAggregator), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode)) {
            this.logger = logger;
            this.ea = ea;
            this.platform = platform;
            this.element = element;
...
let Focus = (() => {
    ...
    let _enabled_extraInitializers = [];
    _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('Focus'), ea = aurelia.resolve(aurelia.IEventAggregator), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode), options = aurelia.resolve(IRgaaConfiguration)) {
            this.logger = logger;
            this.ea = ea;
            this.platform = platform;
            this.element = element;
...
let Tabindex = (() => {
    ...
    var Tabindex = _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('AriaTabindex'), ea = aurelia.resolve(aurelia.IEventAggregator), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode)) {
            this.logger = logger;
            this.ea = ea;
            this.platform = platform;
            this.element = element;
...
let TrapFocus = (() => {
    ...
    var TrapFocus = _classThis = class {
        constructor(options = aurelia.resolve(IRgaaConfiguration), logger = aurelia.resolve(aurelia.ILogger).scopeTo('TrapFocus'), ea = aurelia.resolve(aurelia.IEventAggregator), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode)) {
            this.options = options;
            this.logger = logger;
            this.ea = ea;
            this.platform = platform;
...
let InvalidFocus = (() => {
    ...
    let _name_extraInitializers = [];
    _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('InvalidFocus'), ea = aurelia.resolve(aurelia.IEventAggregator), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode), options = aurelia.resolve(IRgaaConfiguration)) {
            this.logger = logger;
            this.ea = ea;
            this.platform = platform;
            this.element = element;
...
let RollbackFocus = (() => {
    ...
    _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('RollbackFocus'), ea = aurelia.resolve(aurelia.IEventAggregator), element = aurelia.resolve(aurelia.INode)) {
            this.logger = logger;
            this.ea = ea;
            this.element = element;
...
exports.RgaaConfiguration = RgaaConfiguration;
