...
export { HtmlActions, IHtmlEnded, IHtmlElement, IAriaEnded, IAriaElement, CurrentChannels, CurrentModes, IAriaCurrent, IAriaCurrentEnded, AriaCurrent, ExpandedChannels, ExpandedModes, IAriaExpanded, IAriaExpandedEnded, AriaExpanded, HiddenChannels, HiddenModes, IAriaHidden, IAriaHiddenEnded, AriaHidden, InvalidChannels, InvalidModes, IAriaInvalid, IAriaInvalidEnded, AriaInvalid, LabelChannels, IAriaLabel, IAriaLabelEnded, AriaLabel, LiveChannels, LiveModes, IAriaLive, IAriaLiveEnded, AriaLive, ModalChannels, ModalModes, ModalRoles, IAriaModal, IAriaModalEnded, AriaModal, SelectedChannels, SelectedModes, IAriaSelected, IAriaSelectedEnded, AriaSelected, FocusChannels, IHtmlFocus, IHtmlFocusEnded, Focus, TabindexChannels, IHtmlTabindex, IHtmlTabindexEnded, Tabindex, IHtmlTrapFocus, IHtmlTrapFocusEnded, IHtmlTrapFocusKeydown, TrapFocus, TrapFocusChannels, IHtmlInvalidFocus, IHtmlInvalidFocusEnded, InvalidFocus, InvalidFocusChannels, RollbackFocusChannels, IHtmlRollbackFocus, IHtmlRollbackFocusEnded, RollbackFocus, };
export declare const RgaaConfiguration: {
    register(container: IContainer): IContainer;
    configure(options: ConfigInterface): any;
};
