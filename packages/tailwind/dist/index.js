...
var aurelia2Transition = require('@blackcube/aurelia2-transition');
var aurelia2Aria = require('@blackcube/aurelia2-aria');
...
let MenuMobile = (() => {
    let _classDecorators = [aurelia.customAttribute('bc-tw-menu-mobile')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('MenuMobile'), transitionService = aurelia.resolve(aurelia2Transition.ITransitionService), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode)) {
            this.logger = logger;
...
const IStorageService = aurelia.DI.createInterface('IStorageService', (x) => x.singleton(StorageService));
class StorageService {
    constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('StorageService')) {
        this.logger = logger;
...
const ISidebarService = aurelia.DI.createInterface('ISidebarService', (x) => x.singleton(SidebarService));
class SidebarService {
    constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('SidebarService'), storageService = aurelia.resolve(IStorageService)) {
        this.logger = logger;
...
let MenuSidebar = (() => {
    let _classDecorators = [aurelia.customAttribute('bc-tw-menu-sidebar')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('MenuSidebar'), transitionService = aurelia.resolve(aurelia2Transition.ITransitionService), sidebarService = aurelia.resolve(ISidebarService), ariaService = aurelia.resolve(aurelia2Aria.IAriaService), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode)) {
            this.logger = logger;
            this.transitionService = transitionService;
...
let DropdownMenu = (() => {
    let _classDecorators = [aurelia.customAttribute('bc-tw-dropdown-menu')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('DropdownMenu'), platform = aurelia.resolve(aurelia.IPlatform), transitionService = aurelia.resolve(aurelia2Transition.ITransitionService), ariaService = aurelia.resolve(aurelia2Aria.IAriaService), ea = aurelia.resolve(aurelia.IEventAggregator), element = aurelia.resolve(aurelia.INode)) {
            this.logger = logger;
            this.platform = platform;
            this.transitionService = transitionService;
            this.ariaService = ariaService;
        ...
        attaching() {
            ...
            this.disposable = this.ea.subscribe(aurelia2Aria.AriaService.trapFocusChannel, this.onTrapFocus);
        }
        attached() {
            this.logger.trace('Attached');
...
let FormDropdown = (() => {
    let _classDecorators = [aurelia.customAttribute('bc-tw-form-dropdown')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    _classThis = class {
        constructor(logger = aurelia.resolve(aurelia.ILogger).scopeTo('FormDropdown'), platform = aurelia.resolve(aurelia.IPlatform), element = aurelia.resolve(aurelia.INode), ea = aurelia.resolve(aurelia.IEventAggregator), ariaService = aurelia.resolve(aurelia2Aria.IAriaService)) {
            this.logger = logger;
            this.platform = platform;
            this.element = element;
            this.ea = ea;
        ...
        attaching() {
            this.logger.trace('Attaching');
            this.disposable = this.ea.subscribe(aurelia2Aria.AriaService.trapFocusChannel, this.onTrapFocusKeydown);
            this.button = this.element.querySelector('button');
...
exports.ITailwindConfiguration = ITailwindConfiguration;
