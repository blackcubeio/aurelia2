import { DI, customAttribute, bindable, BindingMode, resolve, ILogger, IPlatform, INode } from 'aurelia';

const IRecaptchaConfiguration = DI.createInterface('IRecaptchaConfiguration', x => x.singleton(RecaptchaConfigure));
...
let Recaptcha = (() => {
    let _classDecorators = [customAttribute("bc-recaptcha")];
    ...
    _classThis = class {
        constructor(logger = resolve(ILogger), platform = resolve(IPlatform), element = resolve(INode), options = resolve(IRecaptchaConfiguration)) {
            this.logger = logger;
    ...
    (() => {
        ...
        _badge_decorators = [bindable({ mode: BindingMode.oneTime })];
        _size_decorators = [bindable({ mode: BindingMode.oneTime })];
        _theme_decorators = [bindable({ mode: BindingMode.oneTime })];
        _event_decorators = [bindable({ primary: true, mode: BindingMode.oneTime })];
...
export { IRecaptchaConfiguration, RecaptchaConfiguration };
